...
class S {
  ...
  static String get navOpponentAnalysis => _s('Opponent Analysis', 'Rakip Analizi');
  ...
  static String get opponentAnalysisF6 => _s('Opponent Analysis (F6)', 'Rakip Analizi (F6)');
  static String get resetBoard => _s('Reset Board (Ctrl+Del)', 'Tahtayı Sıfırla (Ctrl+Del)');
  static String get playSelectedMove => _s('Play Selected Move', 'Seçili Hamleyi Oyna');

  // ─── Dashboard Screen ────────────────────────────────────────────
  static String get dashboard => _s('Dashboard', 'Dashboard');
  static String get dashboardSubtitle => _s('Your ScrabbleBot game statistics', 'Kelimelik Pro oyun istatistiklerin');
  ...
  static String get lastSearchResult => _s('Last search result', 'Son arama sonucu');
  static String get highestScore => _s('Highest Score', 'En Yüksek Puan');
  static String get bestMoveOnBoard => _s('Best move on current board', 'Mevcut tahtadaki en iyi hamle');
  static String get strong => _s('Strong', 'Güçlü');
  static String get remainingLetters => _s('Remaining Letters', 'Kalan Harfler');
  static String get tilesLeftInBag => _s('Tiles left in bag', 'Torbada kalan harf sayısı');
  static String get scoreDistribution => _s('Score Distribution', 'Puan Dağılımı');
  static String get first30Chart => _s('Score chart of first 30 moves', 'İlk 30 hamlenin puan grafiği');
  static String get goToGameBoard => _s('Go to the game board to find moves', 'Hamle bulmak için oyun tahtasına geçin');
  static String get topMoves => _s('Top Moves', 'En İyi Hamleler');
  static String get top10 => _s('Top 10', 'İlk 10');
  static String get noMovesCalculated => _s('No moves calculated yet', 'Henüz hamle hesaplanmadı');

  // ─── Dictionary Screen ───────────────────────────────────────────
  static String get dictionary => _s('Dictionary', 'Sözlük');
  static String get dictSubtitle => _s('Search, verify, and manage words', 'Kelime ara, kontrol et ve sözlüğü yönet');
  ...
  static String get typeToSearch => _s('Type above to search words', 'Kelime aramak için yukarıya yazın');
  static String noMatchingWord(String q) => _s('No words matching "$q"', '"$q" ile eşleşen kelime yok');
  static String get copy => _s('Copy', 'Kopyala');
  static String dictLoadError(String e) => _s('Dictionary load failed: $e', 'Sözlük yüklenemedi: $e');

  // ─── Analytics Screen ────────────────────────────────────────────
  static String get analytics => _s('Analytics', 'Analiz');
  static String get analyticsSubtitle => _s('Statistical analysis of found moves', 'Bulunan hamlelerin istatistiksel analizi');
  static String get totalMoves => _s('Total Moves', 'Toplam Hamle');
  static String get allFoundMoves => _s('all found moves', 'bulunan tüm hamleler');
  ...
  static String get avgWordLength => _s('Avg Word Length', 'Ort. Kelime Uzunluğu');
  static String get letters => _s('letters', 'harf');
  static String get noMovesFound => _s('No moves found yet', 'Henüz hamle bulunamadı');
  static String get directionDist => _s('Direction Distribution', 'Yön Dağılımı');
  ...
  static String get mostUsedLetters => _s('Most Used Letters', 'En Çok Kullanılan Harfler');

  // ─── Settings Screen ─────────────────────────────────────────────
  static String get settings => _s('Settings', 'Ayarlar');
  static String get settingsSubtitle => _s('Theme, game type, and app settings', 'Tema, oyun tipi ve uygulama ayarları');
  ...
  static String get classicDesc => _s('Standard Scrabble board', 'Standart Kelimelik tahtası');
  ...
  static String get keyboardShortcuts => _s('Keyboard Shortcuts', 'Kısayol Tuşları');
  ...
  static String get opponentAnalysis => _s('Opponent Analysis', 'Rakip Analizi');
  ...
  static String tilesRemaining(int n) => _s('$n tiles remaining', '$n taş kaldı');
  static String get findOpponentMoves => _s('Find Opponent Moves', 'Rakip Hamleleri Bul');
  static String get runOpponentAnalysis => _s(
    'Run opponent analysis to\nsee possible moves',
    'Rakip analizi çalıştırarak\nolası hamleleri görün',
  );
  static String get possibleOpponentMoves => _s('Possible Opponent Moves', 'Olası Rakip Hamleleri');
  ...
  static String lettersSelected(int n) => _s('$n letters selected', '$n harf seçili');
  static String get selectLettersToSwap => _s(
    'Select the letters you want to swap',
    'Değiştirmek istediğiniz harfleri seçin',
  );
  static String get discardedLetters => _s('Discarded letters', 'Atılan harfler');
  ...
  static String get enterWordHorizontal => _s('Enter Word Horizontally', 'Yatay Kelime Gir');
  static String get enterWordVertical => _s('Enter Word Vertically', 'Dikey Kelime Gir');
  ...
  static String wordAtPosition(String pos) => _s('Word at position $pos...', '$pos konumuna kelime...');

  // ─── Results Table ───────────────────────────────────────────────
  static String get results => _s('Results', 'Sonuçlar');
  static String get enterLettersToFind => _s(
    'Enter letters to find moves',
  ...
  static String get aiInputHint => _s('Type a command or question...', 'Komut veya soru yazın...');
  ...
  // ─── AI Chat Responses ───────────────────────────────────────────
  static String get aiBoardCleared => _s('Board cleared! ✅', 'Tahta temizlendi! ✅');
  ...
  static String get aiSelectedPlayed => _s('Selected move played! ✅', 'Seçili hamle oynandı! ✅');
  static String get aiSelectFirst => _s(
    'First select a move from the results table.',
    'Önce sonuçlar tablosundan bir hamle seçin.',
  );
  static String aiRemainingTiles(int total, String list) => _s(
  ...
  static String aiStatusReport(int dictSize, String boardType, int moveCount, int bestScore, int remaining) => _s(
    'Status Report:\n'
  ...
  // ─── Error Messages ──────────────────────────────────────────────
  static String get dictLoadFailed => _s('Dictionary could not be loaded', 'Sözlük yüklenemedi');
  static String get enterHandLetters => _s('Please enter your hand letters', 'Lütfen elinizdeki harfleri girin');
  static String solverError(String e) => _s('Solver error: $e', 'Çözüm hatası: $e');
